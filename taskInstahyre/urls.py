...
from users.views import UserProfileCreateView, ContactCreateView, ContactListView, SearchView, SpamReportCreateView, SearchByPhoneView
...
urlpatterns = [
    ...
    path('api/searchByPhone/',SearchByPhoneView.as_view(),name='searchByPhone'),
